...
(function() {
    ...
    if (IsMobile()) {
        console.log("responsive.js says mobile");
        AddCSS("index-mobile.css");
    
        AddScript("map-mobile.js");
    }
    else {
        console.log("responsive.js says desktop");
